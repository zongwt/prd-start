 ...
 * 
 * @author zongwt 2015-7-10 18:34:07
 *
...
public class JedisUtil {
	...
	private static ShardedJedis getInstance() {
				...
				if (INSTANCE_INIT_LOCL.tryLock(2, TimeUnit.SECONDS)){
					...
					try {
						...
						if (shardedJedisPool == null) {
							...
							logger.info("prd-sso, JedisUtil.ShardedJedisPool init success.");
						}
		...
		if (shardedJedisPool == null) {
			throw new NullPointerException("prd-sso, JedisUtil.ShardedJedisPool is null.");
		}
